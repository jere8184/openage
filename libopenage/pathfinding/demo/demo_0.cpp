...
void RenderManager0::show_cost_field(const std::shared_ptr<path::CostField<path::SECTOR_SIZE>> &field) {
...
void RenderManager0::show_integration_field(const std::shared_ptr<path::IntegrationField<path::SECTOR_SIZE>> &field) {
	Eigen::Matrix4f model = Eigen::Matrix4f::Identity();
...
void RenderManager0::show_flow_field(const std::shared_ptr<path::FlowField<path::SECTOR_SIZE>> &flow_field,
...
void RenderManager0::show_vectors(const std::shared_ptr<path::FlowField<path::SECTOR_SIZE>> &field) {
...
renderer::resources::MeshData RenderManager0::get_cost_field_mesh(const std::shared_ptr<CostField<path::SECTOR_SIZE>> &field,
                                                                  size_t resolution) {
...
renderer::resources::MeshData RenderManager0::get_integration_field_mesh(const std::shared_ptr<IntegrationField<path::SECTOR_SIZE>> &field,
                                                                         size_t resolution) {
	// increase by 1 in every dimension because to get the vertex length
	// of each dimension
	util::Vector2s size{
...
renderer::resources::MeshData RenderManager0::get_flow_field_mesh(const std::shared_ptr<FlowField<path::SECTOR_SIZE>> &flow_field,
                                                                  const std::shared_ptr<path::IntegrationField<path::SECTOR_SIZE>> &int_field,
                                                                  size_t resolution) {
	// increase by 1 in every dimension because to get the vertex length
	// of each dimension
